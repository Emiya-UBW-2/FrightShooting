		...
		public:
			...
			void			SetDraw(std::function<void()> doing_rigid, std::function<void()> doing) noexcept {
				...
				tmp_cam.FlipCamInfo();
				{
					...
					this->m_Shader.SetPixelParam(3, ShadowLevel, this->m_Scale * 500.f, Scale3DRate * 0.1f * ThresholdLevel, Scale3DRate * 25.f * ThresholdLevel);
					...
					this->m_DepthScreenHandle.SetUseTextureToShader(1);
					this->m_DepthFarScreenHandle.SetUseTextureToShader(2);
					this->m_ShaderRigid.SetPixelParam(3, ShadowLevel, this->m_Scale * 500.f, Scale3DRate * 0.1f * ThresholdLevel, Scale3DRate * 25.f * ThresholdLevel);
